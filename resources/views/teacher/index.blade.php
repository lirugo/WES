            ...
            <div class="col s12 m6 l4">
                <div class="card hoverable">
                    ...
                    <div class="card-content">
                        ...
                        <blockquote class="m-b-0 m-t-5"><small>@lang('app.Created at') - {{$teacher->created_at->format('Y-m-d')}}</small></blockquote>
                    </div>
                    <div class="card-action right-align">
                        <a href="{{url('/teacher/'.$teacher->id)}}" class="indigo waves-effect waves-light btn-small right">@lang('app.Open')</a>
                    </div>
                </div>
            </div>
        @endforeach
