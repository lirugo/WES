            ...
            <div class="card hoverable">
                <div class="card-content">
                    ...
                    <div class="input-field col s12 m6 l6">
                        ...
                        <select class="icons" name="teacher_id" required disabled>
                    ...
                    <div class="input-field col s12 m6 l6">
                        ...
                        <select name="discipline_id" required>
                            ...
                            @foreach(Auth::user()->disciplines as $discipline)
                                <option value="{{$discipline->get->id}}" {{ old('discipline') == $discipline->get->id ? 'selected="selected"' : '' }}>{{$discipline->get->display_name}}</option>
                            @endforeach
                        </select>
