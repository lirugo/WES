@if(Auth::user()->hasRole('student'))
    ...
    @else
        <li><a class="subheader">@lang('app.Student')</a></li>
        <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                @if($team->video_lessons)
                                    <li><a href="{{url('/team/'.$team->name.'/video-lesson')}}"><i class="material-icons">ondemand_video</i>@lang('app.Video Lessons')</a></li>
                                @endif
