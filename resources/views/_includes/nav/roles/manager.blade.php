  ...
  <ul class="collapsible">
    <li>
      ...
      <div class="collapsible-body">
        <ul>
          <li><a href="{{url('/student/create')}}"><i class="material-icons">person_add</i>
              @lang('app.Create a new student')</a></li>
    ...
    <li>
      ...
      <div class="collapsible-body">
        <ul>
          <li><a href="{{url('/team/create')}}"><i class="material-icons">group_add</i>
              @lang('app.Create a new group')</a></li>
          ...
          <li><a href="{{url('/team/'.$team->name)}}"><i class="material-icons">group</i>{{$team->display_name}}</a>
          </li>
          @endforeach
        </ul>
      </div>
