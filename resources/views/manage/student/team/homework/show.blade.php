@extends('layouts.app')
@section('breadcrumbs')
    {{ Breadcrumbs::render('student-team-homework-discipline', $team, $discipline->getDiscipline) }}
@endsection
@section('content')
    <div class="row">
            ...
            <div class="col s12 m6 l6">
                <div class="card hoverable">
                    ...
                    <div class="card-action right-align">
                        <a href="{{url('/manage/student/team/'.$team->name.'/homework/'.$discipline->getDiscipline->name.'/'.$homeWork->name)}}" class="indigo waves-effect waves-light btn-small right">Open</a>
                    </div>
                </div>
            </div>
        @endforeach
