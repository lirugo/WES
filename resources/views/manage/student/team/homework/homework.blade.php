@extends('layouts.app')
@section('breadcrumbs')
    {{ Breadcrumbs::render('student-team-homework-discipline-homework', $team, $discipline->getDiscipline, $homeWork) }}
@endsection
@section('content')
    {!! Form::open(['route' => ['manage.student.team.homework.store', $team->name, $discipline->getDiscipline->name, $homeWork->name], 'enctype' => 'multipart/form-data', 'method' => 'POST']) !!}
    <div class="row">
